...
maxSignalError=5 
adjustableSignalErrorInEnv=int(sys.argv[1]) #  use 4 for carrying in hand, 6 for carrying in pocket -> cok fazla 8 yerine 6 yap, 5 yerine 4
numberOfReceivers=3
...
def animate(iterNo, ax, macID, currPerson, NumberOfParticles,  xdims=(0, 50), ydims=(0, 50), maxSignalError=20,  movingLimit=2, pastCoeff=0, minUsefulSignal=-90, 
    ...
    if iterNo >=4 and iterNo <54:
        ...
        if isProcessed:
            ...
            with open("1841_mu_"+str(adjustableSignalErrorInEnv)+".txt","a+") as myOutFile:
