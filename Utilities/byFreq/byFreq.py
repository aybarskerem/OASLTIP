...
if len(sys.argv)!=4:
    print "run as 'python <script name> <number of receivers> <seed no> <output file name>'"
    exit(1)
...
MaxWaitingForPerson=0

#totalIterNo=16
totalIterNo=3
NumberOfParticles=300
xdims=(0,14)  # our office's coordinates
ydims=(0,11)
#xdims=(0,3) 
#ydims=(0,2)
...
def animate(iterNo, macID, currPerson, NumberOfParticles,  xdims=(0, 50), ydims=(0, 50), maxSignalError=20,  movingLimit=2, pastCoeff=0, minUsefulSignal=-90, 
    ...
    if iterNo == totalIterNo-1:
        ...
        with open(sys.argv[3]+"_avgError.txt","a+") as outFile:
        ...
        with open(sys.argv[3]+"_noSignalError.txt","a+") as outFile:
